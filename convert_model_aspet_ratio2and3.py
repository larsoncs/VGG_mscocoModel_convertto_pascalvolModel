...
import os
os.chdir('..')
caffe_root = '/data/home/larsonwang/object_detect/refineDetFocalloss/'
import sys
...
coco_net = caffe.Net(caffe_root + 'models/VGGNet/coco/new_refinedet_vgg16_512x512/deploy.prototxt',
                     caffe_root + 'models/VGGNet/coco/new_refinedet_vgg16_512x512/coco_new_refinedet_vgg16_512x512_iter_40000.caffemodel',
                     caffe.TEST)

voc_net = caffe.Net(caffe_root + 'models/VGGNet/VOC0712Plus/refinedet_vgg16_512x512_train/deploy.prototxt',
                    caffe_root + 'models/VGGNet/VOC0712Plus/refinedet_vgg16_512x512_train/VOC0712Plus_refinedet_vgg16_512x512_train_iter_59.caffemodel',
                    caffe.TEST)
...
file = open(caffe_root + 'models/VGGNet/coco/new_refinedet_vgg16_512x512/deploy.prototxt', 'r')
...
file = open(caffe_root + 'models/VGGNet/VOC0712Plus/refinedet_vgg16_512x512_train/deploy.prototxt', 'r')
...
num_bboxes = [5, 5, 5, 5]  #1,2,1/2,3,1/3 ;new add 3,1/3
